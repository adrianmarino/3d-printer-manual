...
3. Posiciona el cabezal en Home con el comando `G28`.
4. Utiliza un objeto cubo de 30mmx30mmx0.2mm y colócalo en el centro de la cama. Este objeto se imprime muy rápido, permitiendo realizar impresiones con cada ajuste del z-offset para obtener un resultado rápidamente.
