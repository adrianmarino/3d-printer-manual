...
-   `/*.md` (Raíz): Todas las guías temáticas se alojan en la raíz del repositorio (ej. `bed-mesh-calibration.md`, `filamentos-resistencia.md`, `k1-max-setup.md`, `k1-max-firmware.md`, `k1-max-config.md`).
