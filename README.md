...
* [🛠️ Guía de Calibración del Z-Offset](./zoffset-calibration.md)
...
* [🤖 LiDAR y Funciones IA de la K1 Max](./lidar-ai-calibracion.md)
  > Activa y usa el LiDAR de la K1 Max: detección de primera capa y calibración automática de flujo (Motion Advance) con Creality Print.
